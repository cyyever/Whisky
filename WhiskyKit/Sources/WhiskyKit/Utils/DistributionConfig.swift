...
public enum DistributionConfig {
    ...
    public static let baseURL = "https://cyyever.github.io/Whisky"
    ...
    public static let releasesBaseURL = "https://github.com/cyyever/Whisky/releases/download"
    ...
    /// - Parameter version: The version string (e.g., "3.0.0")
